...
export default function Lesson02() {
  return (
    <LessonLayout title="Conditions, parameters and nested loops" lessonId="module01-lesson02" total={4} modulePath="/module/01" prevPath="/module/01/lesson/01" nextPath="/module/02">
      {(progress) => (
        <>
          <p>
